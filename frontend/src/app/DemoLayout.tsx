...
export default function DemoLayout() {
  ...
  useEffect(() => {
    document.title = `${novelTitle} · ${tabLabel} — ARBOR Demo`
  }, [novelTitle, tabLabel])
  ...
  return (
    <DemoProvider slug={novelSlug}>
      ...
      <div className="flex h-screen flex-col items-center justify-center bg-slate-950 p-6 text-center md:hidden">
        ...
        <h1 className="mb-2 text-xl font-bold text-white">ARBOR Demo</h1>
        ...
        <div className="flex gap-3">
          <a
            href="https://anonymous.4open.science/r/arbor-x9k3a"
            target="_blank"
