      ...
      <div className="flex-1 overflow-auto" id="settings-scroll">
        ...
        <div className="max-w-2xl mx-auto p-6 space-y-8">
          ...
          <section className="text-center text-[10px] text-muted-foreground pb-8 space-y-1">
            <p>ARBOR v{__APP_VERSION__} · 本地运行 · 完全隐私</p>
            <p>
              <a href="https://example.com/docs/" target="_blank" rel="noopener" className="text-blue-500 hover:text-blue-400 transition">使用文档</a>
              {" · "}
              <a href="https://example.com/docs/faq" target="_blank" rel="noopener" className="text-blue-500 hover:text-blue-400 transition">常见问题</a>
            </p>
          </section>
        </div>
      </div>
