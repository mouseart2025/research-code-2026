...
#
# Output:
#   src-tauri/binaries/arbor-sidecar-<target-triple>
#
# Prerequisites:
...
uv run pyinstaller arbor-sidecar.spec --noconfirm --clean 2>&1

DIST_BIN="$BACKEND_DIR/dist/arbor-sidecar"
...
DEST="$BINARIES_DIR/arbor-sidecar-${TARGET_TRIPLE}"
