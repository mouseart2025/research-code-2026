"""Build the ARBOR sidecar binary using PyInstaller.
...
Output:
    frontend/src-tauri/binaries/arbor-sidecar-{target_triple}
"""
...
def main() -> None:
    ...
    bin_name = f"arbor-sidecar-{target}"
    ...
    src = ROOT / "dist" / f"arbor-sidecar{src_ext}"
