"""Evaluate ARBOR extraction on 《星尘劫》 vs the Phase 1 bible gold.

Compares ARBOR's pipeline output against the synthetic novel's ground
...
Reads:
    ...
    ~/.arbor-v2/data.db  (world_structures + chapter_facts)
