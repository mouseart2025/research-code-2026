...
_STOPWORDS: set[str] = {
    ...
    "听得", "看了", "看得", "说了", "听了", "只得", "不敢", "不知", "不见", "只管", "见了", "问道", "答道", "回道", "叫道", "今日", "商议",
    "如此", "如此这般", "只好", "便去", "便道", "上前",
...
class EntityPreScanner:
    ...
    def _scan_word_freq(self, full_text: str) -> Counter:
        ...
        for word, flag in pseg.cut(text):
            ...
            if flag.startswith(("nr", "ns", "nz", "n")) or (
                len(word) >= 3
