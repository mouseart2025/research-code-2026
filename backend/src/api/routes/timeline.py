...
from src.services.visualization_service import get_analyzed_range, get_timeline_data
...
async def get_timeline(
    ...
    if first == 0:
        return {
            "events": [], "swimlanes": {}, "analyzed_range": [0, 0],
            "suggested_hidden_types": [], "suggested_min_swimlane": 1,
            "total_swimlanes": 0,
        }
